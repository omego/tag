...
///////////////////////////////////////////////////////////////
//For creating the 2nd page which includes the medium sized tag/
///////////////////////////////////////////////////////////////
...
<input name="go" type="submit" class="button-x" value="Create" type="button">
								...
								<div class="column-b">
									<input name="go" class="button-x" value="Create" onclick="getSuccessOutput();meduim();"   type="button">
								...
								<div class="column-x">
									<canvas class="canvas" id="e2" width="1700" height="648"></canvas>
